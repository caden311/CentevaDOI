...
export class TypeAheadComponent implements OnInit, OnDestroy, ControlValueAccessor {
  ...
  @Input() public keepFocused = false;
  ...
  @ViewChild('dropDownComponent', {static: false}) public dropDownComponent;
  @ViewChild('dropDownItem', {static: false}) public dropDownItem;
